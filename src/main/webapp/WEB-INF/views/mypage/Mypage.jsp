...
<div class="container col-md-6">
    <h1 class="text-center mt-5">마이페이지</h1>
        <div style="display: flex;" >
            <button class="subscribe button mg5" style="display: flow" onclick=location.href="/mypage/listMystars">내 별자리</button>
            <button class="subscribe button mg5"onclick=location.href="/mypage/Myinfo">회원 정보</button>
            <button class="subscribe button mg5"onclick=location.href="/PwdChange">비밀번호 변경</button>
            <button class="subscribe button mg5"onclick=doDelete()>회원 탈퇴</button>
        </div>
</div>
<br>
<div class="container rounded-3 py-3" style="background-color: #394264;">
    <div id='calendar'></div>
</div>
